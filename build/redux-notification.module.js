    ...
    createClass(Notification, [{
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement('div', { style: { width: this.state.progress + '%' }, className: classes$1.ProgressBar })
            );
        }
    }, {
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                this.props.notifications.map(function (notification) {
                    return React.createElement(Notification, _extends({ key: notification.id }, notification, { remove: _this2.props.remove }));
                })
            );
        }
    }]);
...
var Notifications$1 = connect(mapStateToProps, {
...
export { Notifications$1 as Notifications, reducer as notificationsReducer, addNotification, removeNotification, ADD_NOTIFICATION, REMOVE_NOTIFICATION, getNotifications, NOTIFICATIONS, addNotificationFromAction };
//# sourceMappingURL=redux-notification.module.js.map
